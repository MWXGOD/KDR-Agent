...
* **argparse**: Parses command-line arguments for flexible configuration.
* **json\_repair**: Repairs and parses imperfect JSON generated by LLMs to improve robustness.
* **wikipedia**: Accesses Wikipedia pages and summaries as external knowledge.
* **requests**: Handles HTTP requests and network-related exceptions.
* **openai**: Provides LLM API access for multi-agent prompting and NER inference.
